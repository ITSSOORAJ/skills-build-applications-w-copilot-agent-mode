...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create workouts
        w1 = Workout.objects.create(name='Pushups', description='Do 20 pushups', suggested_for='all')
        w2 = Workout.objects.create(name='Running', description='Run 5km', suggested_for='all')
